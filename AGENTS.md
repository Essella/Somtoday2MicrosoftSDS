...
12. Preserve cancellation for network, retry, Key Vault, and Blob operations. Follow `SECURITY.md` for security/privacy work and keep tracked configuration non-sensitive.
